...
class FileUploadView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        print(f"[{time.time()}] ------ Received request")
        ...
        print(f"[{time.time()}] ------ Stored original file")

        print(f"[{time.time()}] ------ Begin detect and align face to center of image")
        ...
        print(f"[{time.time()}] ------ Finish detect and align face to center of image")
        ...
        print(f"[{time.time()}] ------ Begin transfer hair style")
        ...
        print(f"[{time.time()}] ------ Finish transfer hair style")
