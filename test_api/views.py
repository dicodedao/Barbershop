...
class FileUploadView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        logging.debug('------ Stored original file')

        logging.debug('------ Begin detect and align face to center of image')
        ...
        logging.debug('------ Finish detect and align face to center of image')
        ...
        logging.debug('------ Begin transfer hair style')
        ...
        logging.debug('------ Finish transfer hair style')
